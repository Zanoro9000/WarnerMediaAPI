...
namespace WarnerMediaAPI.Models
{
    public partial class TitlesContext : DbContext
    {
        ...
        public TitlesContext(DbContextOptions<TitlesContext> options, IConfiguration configuration)
            : base(options)
        {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder options)
        {
            ...
            options.UseSqlServer(config.GetConnectionString("WarnerMediaConnectionString"), opt => opt.CommandTimeout(120));
        }
